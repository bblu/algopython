...
pgcnn=DB(dbname='osm',host='localhost',port=5432,user='uname',passwd='pswd')
...
def genSql(tbname):
    ...
    return cols
#\'major_rail\',\'motorway_link\',\'service\',\'trunk\',\'link\',\'path\',\'track\',\'minor_rail\',\'pedestrian\',\'construction\',\'ferry\',\'street_limited\',\'aerialway\',\'golf\'
